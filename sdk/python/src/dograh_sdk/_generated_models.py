...
#   filename:  dograh-openapi-iojahq.json
#   timestamp: 2026-07-13T06:47:24+00:00
...
class CreateWorkflowRequest(BaseModel):
    ...
    """
    Optional agent language code (e.g. 'hi', 'ta', 'en'). When set, the agent listens (STT), speaks (TTS), and responds (LLM) only in that language. See the supported codes in api.services.configuration.language_support.AGENT_LANGUAGES.
    """
