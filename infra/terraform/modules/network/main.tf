...
resource "aws_route" "private_nat" {
  ...
  destination_cidr_block = "0.0.0.0/0"
  # With a single shared NAT, every private RT points at the one gateway.
...
# --- VPC endpoints (keep ECR pulls / logs / secrets off the NAT) ------------
...
# S3 gateway endpoint (free) — used by ECR layer pulls and the app's S3 access.
